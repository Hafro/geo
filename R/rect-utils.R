...
#' boundary of the ICES statistical area (36Â°00'N, see ICES No. 2 chart)
#' northwards to \samp{99}. The northern limit of the statistical recangle
#' system is thus 85Â°30'N. The longitudinal columns are 1Â° wide, coded in an
#' alphanumeric system which starts at the western boundary of the ICES
#' statistical area (44Â°00'W, see ICES No.1 chart) with \samp{A0}, continuing
#' \samp{A1}, \samp{A2}, \samp{A3} to 40Â°W. East of 40Â°W the system continues
#' \samp{B0}, \samp{B1}, \samp{B2}, \ldots{}, \samp{B9}, \samp{C0}, \samp{C1},
#' \samp{C2}, \ldots{}, \samp{M8}, using a different letter for each 10Â° block
#' and covering the entire west-east extent of the ICES statistical area, thus:
#'
#' \tabular{lrcrl}{ \samp{A0} \tab 44Â°00'W \tab -- \tab 40Â°00'W \tab
#' \samp{A3}\cr \samp{B0} \tab 40Â°00'W \tab -- \tab 30Â°00'W \tab \samp{B9}\cr
#' \samp{C0} \tab 30Â°00'W \tab -- \tab 20Â°00'W \tab \samp{C9}\cr \samp{D0} \tab
#' 20Â°00'W \tab -- \tab 10Â°00'W \tab \samp{D9}\cr \samp{E0} \tab 10Â°00'W \tab
#' -- \tab 0Â°00' \tab \samp{E9}\cr \samp{F0} \tab 0Â°00' \tab -- \tab 10Â°00'E
#' \tab \samp{F9}\cr \samp{G0} \tab 10Â°00'E \tab -- \tab 20Â°00'E \tab
#' \samp{G9}\cr \samp{H0} \tab 20Â°00'E \tab -- \tab 30Â°00'E \tab \samp{H9}\cr
#' \samp{J0} \tab 30Â°00'E \tab -- \tab 40Â°00'E \tab \samp{J9}\cr \samp{K0} \tab
#' 40Â°00'E \tab -- \tab 50Â°00'E \tab \samp{K9}\cr \samp{L0} \tab 50Â°00'E \tab
#' -- \tab 60Â°00'E \tab \samp{L9}\cr \samp{M0} \tab 60Â°00'E \tab -- \tab
#' 68Â°30'E \tab \samp{M8}\cr }
#'
...
#' first. Thus, the recangle of which the southwest corner is 54Â°00'N, 3Â°00'E
#' is coded \samp{37F3}.
...
ir2d <-
  function(ir, useI = FALSE) {
    ...
    lon <- ifelse(lon1 < 0, -44 + lon2 + 0.5, -40 + 10 * lon1 + lon2 + 0.5)
